...
trait PrologMovements:
  def newPositionStraight(x: Int, velocity: Double, time: Int, acceleration: Double): Int
  def newVelocityStraight(car: Car, time: Int, acceleration: Double): Int
...
object PrologMovements:
  ...
  private class PrologMovementsImpl() extends PrologMovements:
    ...
    override def newPositionStraight(x: Int, velocity: Double, time: Int, acceleration: Double): Int =
      engine(s"computeNewPositionForStraight($x, $velocity, $time, $acceleration, Np)")
    ...
    override def newVelocityStraight(car: Car, time: Int, acceleration: Double): Int =
